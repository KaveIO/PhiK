...
if __name__ == '__main__':
    ...
    try:
        import skbuild
        os.environ["PHIK_VERSION_INFO"] = setup_args['version']
        # try building with C++ extension:
        skbuild.setup(**setup_args)
        ...
        setup_args.pop('cmake_install_dir')
        # If this new 'setup' call doesn't fail, the module
        # will be successfully installed, without the C++ extension :
        setup(**setup_args)

    # clean up the build directory when doing an inplace build as this
    # causes issues with CMake cache if rerun
